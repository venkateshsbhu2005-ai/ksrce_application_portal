...
public class MentorController {
    ...
    @GetMapping("/pending")
    public ResponseEntity<List<RequestResponseDto>> getPendingRequests(Principal principal) {
        return ResponseEntity.ok(requestService.getPendingForMentor(principal.getName()));
    }
